...
public class Inscripcion {
	...
	public static List<Inscripcion> findInscripcionEntries(int firstResult, int maxResults, String sortFieldName,
			String sortOrder) {
		...
		if (u.getRol().equals("ROLE_ADMIN") || u.getRol().equals("ROLE_GESTOR")) {
			...
			jpaQuery = "SELECT o FROM Inscripcion o where oferta in (SELECT o FROM Oferta  o where empresa ="
					+ u.getId() + ")";
		}
		...
		return entityManager().createQuery(jpaQuery, Inscripcion.class).setFirstResult(firstResult)
