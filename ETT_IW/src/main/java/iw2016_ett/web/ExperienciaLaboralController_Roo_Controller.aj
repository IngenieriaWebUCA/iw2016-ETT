...
privileged aspect ExperienciaLaboralController_Roo_Controller {
    ...
    void ExperienciaLaboralController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("experienciaLaboral_fechainicio_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("experienciaLaboral_fechafin_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
