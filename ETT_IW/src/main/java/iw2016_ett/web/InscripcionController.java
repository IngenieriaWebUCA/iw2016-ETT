...
public class InscripcionController {
    ...
    public String update(@Valid Inscripcion inscripcion, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        inscripcion.setDemandante(Inscripcion.findInscripcion(inscripcion.getId()).getDemandante());
        inscripcion.setOferta(Inscripcion.findInscripcion(inscripcion.getId()).getOferta());
        inscripcion.merge();
        mail m = new mail();
    ...
    public String create(@Valid Inscripcion inscripcion, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        inscripcion.persist();
        mail m = new mail();
        m.send(inscripcion.getDemandante().getEmail(), "Inscripción", "Usted se ha inscripto en la oferta: " + inscripcion.getOferta().getTitulo());
        return "redirect:/inscripcions/" + encodeUrlPathSegment(inscripcion.getId().toString(), httpServletRequest);
    }
    ...
    public String inscripcionOferta(@PathVariable("oferta") Long ofertaId, Model uiModel) {
        ...
        inscripcion.persist();
        mail m = new mail();
        m.send(inscripcion.getDemandante().getEmail(), "Inscripción", "Usted se ha inscrito en la oferta: " + inscripcion.getOferta().getTitulo());
