...
privileged aspect DemandanteDataOnDemand_Roo_DataOnDemand {
    ...
    public void DemandanteDataOnDemand.setCurriculum(Demandante obj, int index) {
        String Curriculum = "Curriculum_" + index;
    ...
    public void DemandanteDataOnDemand.setEnable(Demandante obj, int index) {
        int enable = index;
    ...
    public void DemandanteDataOnDemand.setResumen(Demandante obj, int index) {
